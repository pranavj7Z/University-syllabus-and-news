...
public class DetailQuestionActivitys3s4 extends subjectsS3S4 {
   // static String pj = "";
    ...
    DatabaseReference mSemRef = mRootRef.child("s3s4");
    DatabaseReference mMaterialRef = mSemRef.child("questions");
    DatabaseReference mQuestionsRef = mMaterialRef.child(course);
    DatabaseReference mCourseRef = mQuestionsRef.child(act);
